    ...
    if [[ -f "$config_file" ]]; then
        ...
        case "$tool_name" in
            "blastn")
                ...
                sed -i.bak "s|<name>gluetools.core.programs.blast.temp.dir</name>.*<value>.*</value>|<name>gluetools.core.programs.blast.temp.dir</name><value>$current_working_dir/blastfiles</value>|g" $config_file
                sed -i.bak "s|<name>gluetools.core.programs.blast.db.dir</name>.*<value>.*</value>|<name>gluetools.core.programs.blast.db.dir</name><value>$current_working_dir/blastdbs</value>|g" $config_file
                ;;
            "tblastn")
            ...
            "mafft")
                ...
                sed -i.bak "s|<name>gluetools.core.programs.mafft.temp.dir</name>.*<value>.*</value>|<name>gluetools.core.programs.mafft.temp.dir</name><value>$current_working_dir/mafftfiles</value>|g" $config_file
                ;;
            "raxmlHPC")
                sed -i.bak "s|<value>.*raxmlHPC</value>|<value>$tool_path</value>|g" $config_file
                sed -i.bak "s|<name>gluetools.core.programs.raxml.temp.dir</name>.*<value>.*</value>|<name>gluetools.core.programs.raxml.temp.dir</name><value>$current_working_dir/raxmlfiles</value>|g" $config_file
                ;;
            "table2asn")
                sed -i.bak "s|<value>.*table2asn</value>|<value>$tool_path</value>|g" $config_file
                sed -i.bak "s|<name>gluetools.core.programs.tbl2asn.temp.dir</name>.*<value>.*</value>|<name>gluetools.core.programs.tbl2asn.temp.dir</name><value>$current_working_dir/tbl2asnfiles</value>|g" $config_file
                ;;
            *)
...
<gluetools>
	...
	<properties>
		...
		<property>
			...
			<value>$current_working_dir/blastfiles</value>
		</property>
		<property>
			<name>gluetools.core.programs.blast.db.dir</name>
			<value>$current_working_dir/blastdbs</value>
		</property>
		...
		<property>
			...
			<value>$current_working_dir/mafftfiles</value>
		</property>
		...
		<property>
			...
			<value>$current_working_dir/raxmlfiles</value>
		</property>
		...
		<property>
			...
			<value>$current_working_dir/tbl2asnfiles</value>
		</property>
	</properties>
</gluetools>
EOL
